...
key_continuous = {
    ...
    # 根据原生决策树提取的绝对阈值
    'TG': {'阈值': 1.92, '方向': '高', '标签': '高TG(>1.92)', '来源': '决策树'},
    'TC': {'阈值': 6.16, '方向': '高', '标签': '高TC(>6.16)', '来源': '决策树'},
    '血尿酸': {'阈值': 383.50, '方向': '高', '标签': '高血尿酸(>383.50)', '来源': '决策树'},

    # 临床固定阈值
    '活动量表总分': {'阈值': 40, '方向': '低', '标签': '低活动量(<40分)', '来源': '临床(<40分)'},

    # 其他指标保留动态中位数划分
    'LDL-C': {'阈值': None, '方向': '高', '标签': '高LDL-C', '来源': '动态中位数'},
    'HDL-C': {'阈值': None, '方向': '低', '标签': '低HDL-C', '来源': '动态中位数'},
